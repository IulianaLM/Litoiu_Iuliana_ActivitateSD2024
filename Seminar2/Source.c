...
int main()
{
	...
	struct Farmacie fCautata = getFarmacieByID(farmacii, nrFarmacii, 3);
	printf("\nFarmacie cautata by id\n");
	afisareFarmacie(fCautata);
	free(fCautata.nume);
